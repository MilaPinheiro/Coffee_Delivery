...
export const SuccessOrder = ({onConfirmOrder, selectedPaymentMethod, addressData}) => {
                                ...
                                <div className={styles.boxConfirm}>
                                    ...
                                    <div className={styles.SuccessIcons}>
                                        ...
                                        <div className={styles.BoxSuccessCards}>
                                            <p>Entrega em <span className={styles.SuccessSpan}>{`${addressData.rua}, ${addressData.numero}`}</span></p>
                                    ...
                                    <div className={styles.SuccessIcons}>
                                        ...
                                        <div className={styles.BoxSuccessCards}>
                                            ...
                                            <span className={styles.SuccessSpan}>{selectedPaymentMethod}</span>
                                        </div>
                                    </div>
